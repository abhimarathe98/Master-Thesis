function path = adaptive_astar_path(start_pos, goal_pos, grid_size, obstacles, ap_positions, ~)
    ...
    % Parameters for signal influence and cost balancing
    base_signal_weight = 0.5;
    distance_weight = 2;
    dynamic_adjustment = 0.1;
    goal_threshold_factor = 1.01;

    % Calculate the RSSI map based on APs for the current grid
    ...
    while ~isempty(open_list)
        ...
        for i = 1:size(directions, 1)
            ...
            % Adjust signal weight based on proximity to the goal
