function path = adaptive_astar_path(start_pos, goal_pos, grid_size, obstacles, ap_positions, robot_id)
    ...
    base_signal_weight = 2.5;  % Further reduced base signal weight for balanced influence
    distance_weight = 1;  % Weight for distance cost
    dynamic_adjustment = 0.2;  % Fine-tuned factor for smooth signal adjustment
    goal_threshold_factor = 1.05;  % Threshold factor to prioritize goal over signal
