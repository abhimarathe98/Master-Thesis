...
fill([105 105 120 120], [110 120 120 110], 'k'); % Unloading Rack 1

fill([105 105 120 120], [130 140 140 130], 'k'); % Unloading Rack 2

fill([105 105 120 120], [170 180 180 170], 'k'); % Unloading Rack 3
...
unloading_x = [122.5, 122.5, 122.5];
unloading_y = [115, 135, 175];
