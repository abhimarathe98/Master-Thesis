function obstacles = obstacle_map(grid_size)
    ...
    %% Room 3 (Top Right)
    obstacles(110:120, 105:120) = 1;   % Unloading Rack 1
    obstacles(130:140, 105:120) = 1;   % Unloading Rack 2
    obstacles(170:180, 105:120) = 1;   % Unloading Rack 3
    obstacles(123:188, 140:190) = 1;   % Unloading Rack 4
